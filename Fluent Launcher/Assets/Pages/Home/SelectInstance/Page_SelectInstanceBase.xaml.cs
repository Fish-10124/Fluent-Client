...
namespace Fluent_Launcher.Assets.Pages.Home.SelectInstance
{
    ...
    /// </summary>
    public sealed partial class Page_SelectInstanceBase : Page
    {
        public Page_SelectInstanceBase()
        {
            this.InitializeComponent();

            BreadcrumbBar_Title.AddItem(new(typeof(Page_SelectInstance), "Select Instance"));
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Frame_Content.Navigate(typeof(Page_SelectInstance), e.Parameter);
        }
    }
}
