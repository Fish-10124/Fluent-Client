...
namespace Fluent_Launcher.Assets.Pages.Download.Instances
{
    ...
    /// </summary>
    public sealed partial class Page_InstancesBase : Page
    {

        public Page_InstancesBase()
        {
            this.InitializeComponent();

            BreadcrumbBar_Title.AddItem(new(typeof(Page_InstancesList), "Instances"));
        }
        ...
        private void Frame_Content_Navigated(object sender, NavigationEventArgs e)
        {
            ...
            {
                if (frame.Content.GetType() == typeof(Page_InstanceOption))
                {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Frame_Content.Navigate(typeof(Page_InstancesList), e.Parameter);
        }
    }
}
