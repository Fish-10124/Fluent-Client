...
namespace Fluent_Launcher.Assets.Pages.Download.Mods
{
    ...
    /// </summary>
    public sealed partial class Page_ModsBase : Page
    {
        public Page_ModsBase()
        {
            this.InitializeComponent();

            BreadcrumbBar_Title.AddItem(new(typeof(Page_ModsList), "Mods"));
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Frame_Content.Navigate(typeof(Page_ModsList), e.Parameter);
        }
    }
}
